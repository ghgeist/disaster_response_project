...
**ARCHIVED**: 2026-02-03  
**REASON**: Functionality consolidated into `code-improvement-agent.md` which now includes structural coherence principles and comprehensive refactoring guidance.
